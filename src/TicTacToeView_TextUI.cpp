...
//***************************************************************************
#include "../include/TicTacToeView_TextUI.h"
#include "../include/TicTacToePresenter.h"
#include <sstream>
...
TicTacToeView_TextUI::~TicTacToeView_TextUI ()
{
  delete mpcTTTPresenter;
	/* 
		~TextUI() will deallocate all widgets send to
		addWidget()
	*/
}
...
//
// Description:  From Presenter: Set the current turn message
//
// Parameters:  name - the current player's name
//
// Returned:    None
//***************************************************************************
void TicTacToeView_TextUI::setCurrentTurn(std::string name) {
	mpCurrentTurn->setData (name);
}
